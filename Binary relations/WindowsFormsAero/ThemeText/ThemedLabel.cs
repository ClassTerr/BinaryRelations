...
namespace WindowsFormsAero.ThemeText
{
    ...
    public class ThemedLabel : Label//must be label
    {
        Timer t = new Timer();
        public ThemedLabel()
        {
            ...
            GlassEnabled = OsSupport.IsCompositionEnabled;
        }
        ...
        public HorizontalAlignment TextAlign
        {
            ...
            set
            {
                switch (value)
                {
                    case HorizontalAlignment.Center: l.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
                        break;
                    case HorizontalAlignment.Left: l.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
                        break;
                    case HorizontalAlignment.Right: l.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
                        break;
                }
                _horizontal = value;
                UpdateText();
